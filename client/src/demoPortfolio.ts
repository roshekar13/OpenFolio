...
export const DEMO_WATCHLIST: WatchlistResponse = {
  max: 4,
  items: [
    { ticker: "AMD", priceUsd: 118.4, change2wPct: 0.034 },
    { ticker: "META", priceUsd: 612.5, change2wPct: -0.012 },
    { ticker: "TSLA", priceUsd: 294.3, change2wPct: 0.021 },
    { ticker: "AMZN", priceUsd: 228.9, change2wPct: 0.008 },
  ],
};
